eesy.define(['jquery-private', 'json!language-supportcenter', 'system-information', 'mustachejs'],
  ...
  var fieldTemplatesList = [
    ...
    },
    {
      ...
      setupMembers: function(id, categoryPath) {
        return {
          value: function() { return categoryPath; }
        };
      },
      mailHtml: function(context) {
    ...
    },
    {
      ...
      setupMembers: function(id) {
        return {
          value: function() { return $(".eesy__modal-scope #" + id.replace(/ /g, "")).val(); }
        };
      },
      mailHtml: function(context) {
        return context.templates.mail_section_single_property.html({
    ...
    },
    {
      ...
      setupMembers: function(id) {
        return {
          value: function() { return $(".eesy__modal-scope #" + id.replace(/ /g, "")).is(':checked'); }
        };
      },
      mailHtml: function(context) {
        return context.templates.mail_section_single_property.html({
    ...
    },
    {
      ...
      setupMembers: function(id) {
        return {
          value: function() { return $(".eesy__modal-scope #" + id.replace(/ /g, "") + " .eesy_dateField").val()
        ...
        return {
          value: function() {
            return Mustache.to_html(
                language.LNG.SUPPORT_CENTER.PHONE.CALL_REFERENCE_DETAILS,
  ...
  var validators = {
    "HAS_TEXT": function(id) { return $('.eesy__modal-scope #' + id.replace(/ /g, "")).val().length > 0; },
    "HAS_DATE": function(id) { return $(".eesy__modal-scope #" + id.replace(/ /g, "") + " .eesy_dateField").val().length > 0; },
    "MUST_BE_CHECKED": function(id) { return $('.eesy__modal-scope input#' + id.replace(/ /g, "") + ':checked').length > 0; },
    "HAS_SELECTION": function(id) { return $('.eesy__modal-scope #' + id.replace(/ /g, ""))[0].selectedIndex > 0; },
    "HAS_FILE": function(id) { return $(`#${id}-files`).children().length > 0; },
  };
